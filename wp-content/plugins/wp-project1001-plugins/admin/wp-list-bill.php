 ...
 * Description: Tạo trang danh sách hoá đơn
 * Author: unsersea
 * Plugin Version: v1.0
 */
...
function WP_Form_Bill()
{
    $obj = new WP_Custom_Bill();
    $obj->prepare_items();
    ?>
    <div class="wrap">
        <h2 class="wp-heading-inline"><?php _e('', 'bill') ?> <a class="page-title-action" href="<?php echo admin_url(''); ?>">Thêm Mới</a></h2>
