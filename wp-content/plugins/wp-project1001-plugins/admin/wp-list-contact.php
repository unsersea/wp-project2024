 ...
 * Description: Tạo trang danh sách liên hệ
 * Author: unsersea
 * Plugin Version: v1.0
 */
...
class WP_Custom_Contact extends WP_List_Table
{
    ...
    public function process_bulk_action()
    {
        ...
        $table_name = $wpdb->prefix . $set_name_pj . "contact";
...
function WP_Form_Contact()
{
    $obj = new WP_Custom_Contact();
    $obj->prepare_items();
    ?>
    <div class="wrap">
        <h2 class="wp-heading-inline"><?php _e('', 'contact') ?> <a class="page-title-action" href="<?php echo admin_url(''); ?>">Thêm Mới</a></h2>
